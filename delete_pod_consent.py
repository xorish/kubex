...
file = open(f"{path}/temp/temp_buff_po_delete", "r")
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.yes.clicked.connect(lambda: self.pod_delete())
        self.no.clicked.connect(lambda: self.nox())

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", f"Pod ({pod})"))
        self.yes.setText(_translate("MainWindow", "Yes"))
        self.no.setText(_translate("MainWindow", "No"))
        self.label.setText(_translate("MainWindow", f"Are you sure you want to delete \n '{pod}' ?"))
