...
file = open(f"{path}/temp/temp_buff_roll_out_restart", "r")
...
"font: 11pt \"Ubuntu\";")
        ...
        self.yes.clicked.connect(lambda : self.roll_out_restart())
        self.no.clicked.connect(lambda : self.nox())
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", f"Rollout-Restart ({deployment})"))
        self.yes.setText(_translate("MainWindow", "Yes"))
        self.no.setText(_translate("MainWindow", "No"))
        self.label.setText(_translate("MainWindow", f"Are you sure to rollout restart\n'{deployment}' ?"))
def main():
