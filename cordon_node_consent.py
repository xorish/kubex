...
file = open(f"{path}/temp/temp_buff_node_cordon", "r")
...
"font: 11pt \"Ubuntu\";")
        ...
        self.yes.clicked.connect(lambda : self.node_cordon())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", f"Are you sure you want to cordon \n '{node}' ?"))
def main():
