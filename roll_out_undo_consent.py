...
file = open(f"{path}/temp/temp_buff_roll_out_undo", "r")
...
"font: 11pt \"Ubuntu\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", f"Rollout-Undo({deployment})"))
        self.yes.setText(_translate("MainWindow", "Yes"))
        self.no.setText(_translate("MainWindow", "No"))
        self.label.setText(_translate("MainWindow", f"Are you sure to rollout undo \n '{deployment}' ?"))
def main():
