...
file = open(f"{path}/temp/temp_buff_node_delete", "r")
...
"font: 11pt \"Ubuntu\";")
        ...
        self.yes.clicked.connect(lambda : self.node_delete())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", f"Are you sure you want to force delete \n '{node}' ?"))
def main():
